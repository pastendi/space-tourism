      ...
      <div className='container max-w-6xl '>
        <div className='flex flex-col px-6 lg:flex-row'>
          ...
          <div className='flex justify-center items-center mt-28 lg:mt-[440px] lg:w-1/2'>
            <p className='text-darkPrimary w-[150px] md:w-[242px]  lg:w-[274px] h-[150px] md:h-[242px] lg:h-[274px] rounded-full bg-white flex justify-center items-center text-xl md:text-[32px] hover:shadow-2xl hover:shadow-gray-200'>
              EXPLORE
            </p>
          </div>
        </div>
